...
public class Combat {
	...
	private static final String[] MENU_OPTIONS = { "Regular attack", "Parry/defend", "Use a special attack" };
	...
	private static void echoScoreboard(User player, User computer) {
		String hpLine = String.format("HP: %3d/%3d        Foe HP: %3d/%3d", player.curHP, player.maxHP, computer.curHP,
				computer.maxHP);
		String spLine = String.format("SP: %3d/%3d        Foe SP: %3d/%3d", player.curSP, player.maxSP, computer.curSP,
				computer.maxSP);
		Engine.echo(hpLine);
		Engine.echo(spLine);
	}
