...
public class Hospital implements Location {
	...
	private static final String[] MENU_OPTIONS = { "Go outside", "Learn more about the Hazelnut Hospital",
			"Heal your jar" };
	...
	public Location[] getReach() {
		if (reach == null) {
			reach = new Location[] { JarCentral.getInstance(), Jarena.getInstance() };
		}
