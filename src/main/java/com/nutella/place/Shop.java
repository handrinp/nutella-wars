...
public class Shop implements Location {
	...
	private static final String[] MENU_OPTIONS = { "Go outside", "Learn more about the shop",
			"[" + HP_COST + " gold] - Train HP", "[" + ATK_COST + " gold] - Train ATK",
			"[" + DEF_COST + " gold] - Train DEF", "[" + SP_COST + " gold] - Train SP" };
	...
	public Location[] getReach() {
		if (reach == null) {
			reach = new Location[] { JarCentral.getInstance() };
		}
